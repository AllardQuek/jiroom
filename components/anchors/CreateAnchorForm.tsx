...
const PREDEFINED_TYPES: AnchorType[] = ['home', 'work', 'school', 'station', 'custom'];
                    ...
                    <button
                      ...
                      onClick={() => {
                        ...
                        if (anchorType !== 'custom') {
                          form.setValue('color', getAnchorColorForType(anchorType));
                        }
                      }}
                      ...
                      style={
                        field.value === anchorType
                          ? { backgroundColor: anchorType === 'custom' && selectedColor ? selectedColor : ANCHOR_COLORS[anchorType] || getAnchorColorForType(anchorType) }
                          : {}
                      }
                    >
