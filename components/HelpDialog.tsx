        ...
        <div className="space-y-6 text-sm">
            ...
            <div className="space-y-3">
              <div>
                ...
                <ol className="mt-2 space-y-1.5 list-decimal list-inside text-muted-foreground">
                  <li><strong className="text-foreground">{t('step1')}</strong></li>
                  <li><strong className="text-foreground">{t('step2')}</strong></li>
                  <li><strong className="text-foreground">{t('step3')}</strong></li>
                </ol>
              </div>
          ...
          <Section title={t('pages')}>
            <div className="space-y-4">
              <div>
                <strong className="text-foreground">{t('listingsPage.title')}</strong>
                <ul className="mt-1.5 space-y-1 list-disc list-inside text-muted-foreground">
                  <li><strong className="text-foreground">{t('listingsPage.columns')}</strong></li>
                  <li><strong className="text-foreground">{t('listingsPage.actions')}</strong></li>
                  <li><strong className="text-foreground">{t('listingsPage.tools')}</strong></li>
                  <li><strong className="text-foreground">{t('listingsPage.compare')}</strong></li>
                </ul>
              </div>
              <div>
                <strong className="text-foreground">{t('mapPage.title')}</strong>
                <ul className="mt-1.5 space-y-1 list-disc list-inside text-muted-foreground">
                  <li><strong className="text-foreground">{t('mapPage.markers')}</strong></li>
                  <li><strong className="text-foreground">{t('mapPage.commute')}</strong></li>
                  <li><strong className="text-foreground">{t('mapPage.addFromMap')}</strong></li>
                  <li><strong className="text-foreground">{t('mapPage.filter')}</strong></li>
                </ul>
              </div>
              <div>
                <strong className="text-foreground">{t('comparePage.title')}</strong>
                <ul className="mt-1.5 space-y-1 list-disc list-inside text-muted-foreground">
              ...
              <div>
                <strong className="text-foreground">{t('schedulePage.title')}</strong>
                <ul className="mt-1.5 space-y-1 list-disc list-inside text-muted-foreground">
          ...
          <Section title={t('settingsDialog.title')}>
            <p className="mb-2 text-muted-foreground">
              <strong className="text-foreground">{t('settingsDialog.access')}</strong>
            </p>
            <div className="space-y-3">
              <div>
                <strong className="text-foreground">{t('settingsDialog.evaluationTemplates.title')}</strong>
                <ul className="mt-1.5 space-y-1 list-disc list-inside text-muted-foreground">
                  ...
                  <li><strong>{t('settingsDialog.evaluationTemplates.example')}</strong></li>
                </ul>
              </div>
              <div>
                <strong className="text-foreground">{t('settingsDialog.agentQuestions.title')}</strong>
                <ul className="mt-1.5 space-y-1 list-disc list-inside text-muted-foreground">
                  <li>{t('settingsDialog.agentQuestions.create')}</li>
                  <li><strong>{t('settingsDialog.agentQuestions.example')}</strong></li>
                  <li>{t('settingsDialog.agentQuestions.copy')}</li>
                </ul>
              </div>
              <div>
                <strong className="text-foreground">{t('settingsDialog.tenantProfile.title')}</strong>
                <ul className="mt-1.5 space-y-1 list-disc list-inside text-muted-foreground">
          ...
          <Section title={t('scoring.title')}>
            <div className="space-y-3">
              <div>
                <strong className="text-foreground">{t('scoring.howItWorks')}</strong>
                <ul className="mt-1.5 space-y-1 list-disc list-inside text-muted-foreground">
              ...
              <div>
                <strong className="text-foreground">{t('scoring.scoreRanges')}</strong>
          ...
          <Section title={t('anchors.title')}>
            <div className="space-y-3">
              <div>
                <strong className="text-foreground">{t('anchors.whatAre')}</strong>
                <p className="mt-1 text-muted-foreground">
                  {t('anchors.description')}
                </p>
              </div>
              <div>
                <strong className="text-foreground">{t('anchors.howToAdd')}</strong>
              ...
              <div>
                <strong className="text-foreground">{t('anchors.manage')}</strong>
                <ul className="mt-1.5 space-y-1 list-disc list-inside text-muted-foreground">
          ...
          <Section title={t('dataManagement.title')}>
            <div className="space-y-3">
              <div>
                <strong className="text-foreground">{t('dataManagement.yourControl')}</strong>
                <ul className="mt-1.5 space-y-1 list-disc list-inside text-muted-foreground">
              ...
              <div>
                <strong className="text-foreground">{t('dataManagement.backup')}</strong>
                <ul className="mt-1.5 space-y-1 list-disc list-inside text-muted-foreground">
                  <li><strong className="text-foreground">{t('dataManagement.export')}</strong></li>
                  <li><strong className="text-foreground">{t('dataManagement.import')}</strong></li>
                </ul>
              </div>
              <div>
                <strong className="text-foreground">{t('dataManagement.tryIt')}</strong>
                <ul className="mt-1.5 space-y-1 list-disc list-inside text-muted-foreground">
          ...
          <Section title={t('keyboardShortcuts.title')}>
            <p>
              {t('keyboardShortcuts.toggleHelp')}
            </p>
          </Section>
        </div>
      </DialogContent>
