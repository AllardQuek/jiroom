...
test.describe("Screenshots", () => {
  test("01 - Listings (mobile)", async ({ page }) => {
    ...
    await page.screenshot({
      path: "screenshots/01-listings-mobile.png",
      fullPage: true,
    });
  });
  ...
  test("02 - Listings (desktop)", async ({ page }) => {
    ...
    await page.screenshot({
      path: "screenshots/02-listings-desktop.png",
      fullPage: true,
    });
  });
  ...
  test("03 - Schedule (mobile)", async ({ page }) => {
    ...
    await page.screenshot({
      path: "screenshots/03-schedule-mobile.png",
      fullPage: true,
    });
  });
  ...
  test("04 - Compare (mobile)", async ({ page }) => {
    ...
    await page.screenshot({
      path: "screenshots/04-compare-mobile.png",
      fullPage: true,
    });
  });
  ...
  test("05 - Compare (desktop)", async ({ page }) => {
    ...
    await page.screenshot({
      path: "screenshots/05-compare-desktop.png",
      fullPage: true,
    });
  });
  ...
  test("06 - Map (mobile)", async ({ page }) => {
    ...
    await page.screenshot({
      path: "screenshots/06-map-mobile.png",
      fullPage: true,
    });
  });
  ...
  test("07 - Map with filters open (mobile)", async ({ page }) => {
    ...
    await page.waitForTimeout(500);
    await page.screenshot({
      path: "screenshots/07-map-filters-mobile.png",
      fullPage: true,
    });
  });
  ...
  test("08 - Map with anchors panel (mobile)", async ({ page }) => {
    ...
    await page.waitForTimeout(500);
    await page.screenshot({
      path: "screenshots/08-map-anchors-mobile.png",
      fullPage: true,
    });
  });
  ...
  test("09 - Map with filters open (desktop)", async ({ page }) => {
    ...
    await page.waitForTimeout(500);
    await page.screenshot({
      path: "screenshots/09-map-filters-desktop.png",
      fullPage: true,
    });
  });
  ...
  test("10 - Map with anchors (desktop)", async ({ page }) => {
    ...
    await page.waitForTimeout(500);
    await page.screenshot({
      path: "screenshots/10-map-anchors-desktop.png",
      fullPage: true,
    });
  });
});
