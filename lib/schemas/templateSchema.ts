...
export const criterionSchema = z.object({
  ...
  weight: z.coerce.number().min(1, "Weight must be at least 1").max(3, "Weight must be at most 3"),
...
export const createTemplateSchema = templateSchema.omit({ id: true, updated_at: true });
...
export const updateCriterionSchema = criterionSchema.partial().required({ id: true });
